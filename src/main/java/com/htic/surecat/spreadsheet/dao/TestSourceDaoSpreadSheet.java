...
public class TestSourceDaoSpreadSheet {
...
//	}
	...
	public Workbook populateWorkbook(TemplateSpreadSheet templateSpreadSheet) throws InvalidFormatException, IOException   {
		...
		return POIExcelUtils.getWorkbook(new File (templateSpreadSheet.getFilePath()), 0);
	}
